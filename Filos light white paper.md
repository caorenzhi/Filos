<img width="224" alt="image" src="https://user-images.githubusercontent.com/22382662/181385111-9ed9c280-61da-4612-bfa6-34b7e30065c5.png"> 
...
### 1. Data Module in Web2 and Web3
...
### 3. Decentralized AI-Powered Portfolio Management
...
> _“Collaboration always wins over competition... and is more fun, too.”_ <br> **Silvio Micali** (Zero-knowledge proof, Turing award)

#### Objective: Web2 data sourcing. A pipeline to collect all Web2 financial data and provide service.
...
> _"To succeed, we should always ask the 'whys' and 'why nots.'"_ <br> **Andrew C. Yao** (Computational complexity theory, Analysis of algorithms, Yao’s principle, Cryptography, Turing award) 


#### Objective: Launch AI product for analyzing Web2 data
...
> _“We should continually be striving to transform every art into a science: in the process, we advance the art.”_<br> **Donald E. Knuth** (_The Art of Computer Programming_, Turing award)

#### Objective: Launch token and the token for using the data service

- [ ] Launch the testnet
- [ ] Launch the Token
- [ ] Data service using the token 

### 4. John von Neumann Era 
...
> _“All stable processes we shall predict. All unstable processes we shall control.”_<br> **John von Neumann** (Pioneered the modern computer, game theory, nuclear deterrence, Turing award)
...
> _"Sometimes it is the people no one imagines anything of who do the things that no one can imagine."_ <br> **Alan Turing** (Pioneered theoretical computer science and AI, huge contributions to cryptology)

#### Objective: Decentralize all data in Web3! 
...
> _"I do really believe that creativity is computational…It is something we understand the principles behind. So, it’s only a matter of having…neural nets or models that are smarter. That understand the world better."_ <br> **Yoshua Bengio** (A founding father of deep learning, Turing award for AI) 
...
> _"Our intelligence is what makes us human, and AI is an extension of that quality."_ <br> **Yann LeCun** (Turing award for AI)

#### Objective: Innovative educational NFTs  

- [ ] Launch the Soul-bound NFT for education
- [ ] Launch innovative education-based NFTs for our "play, learn and earn" initiative

### 8. Geoffrey Hinton Era 
...
> _"In science, you can say things that seem crazy, but in the long run they can turn out to be right. We can get really good evidence, and in the end the community will come around."_ <br> **Geoffrey Hinton** (Turing award for AI) 


#### Objective: Decentralizing asset management using AI on the blockchain.  
